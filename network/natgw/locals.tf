locals {
  ...
  # VPC configuration from scan file if vpc_id is not provided
  ...
  # Compute public subnet IDs (priority: explicit > auto-discovery > vpc_scan)
  ...
  # Compute private route table IDs (priority: explicit > auto-discovery > vpc_scan)
